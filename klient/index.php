<?php
	...
	if (isset($_SESSION['log_in1']) && $_SESSION['log_in1'] == true)
	{
...
<html>
	<head>
		...
		<link rel="stylesheet" href="css1/logowanie1.css">
	...
	<body>
		...
		<div class="container">
			...
			<div class="mt-3 mb-2">
				<h1 class="ml-auto mr-auto">Księgarnia internetowa</h1>
			</div>
				...
				<form action="zaloguj.php" method="post" autocomplete="off">
					<div class="form-group">
						...
						<div class="input-group">
							...
							<input type="text" id="login" name="log" class="form-control" placeholder="Login" required value="<?php if(isset($_COOKIE['login1'])) { echo $_COOKIE['login1']; }; ?>">
						</div>
					</div>
			...
			<div>
				<label id="reg" class="d-block ml-auto mr-auto mt-3">Nie masz konta? Zarejetruj się:</label>
			</div>

			<div class="row">
				<div class="col-md-4 ml-auto mr-auto">
					<a id="register" class="btn btn-success d-block" href="rejestracja.php" role="button">Rejestracja</a>
				</div>
			</div>
