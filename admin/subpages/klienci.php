...
<html>
    ...
    <body>
        ...
        <main>
            ...
            <div class="container text-center mb-3">
                ...
                <div class="form-check form-check-inline">
                    ...
                    <label class="form-check-label text-warning font-weight-bold" for="radio1">Nr klienta</label>
                </div>

                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="radiobtn" id="radio2" value=2>
                    <label class="form-check-label text-warning font-weight-bold" for="radio2">Nazwisko</label>
                </div>

                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="radiobtn" id="radio3" value=3>
                    <label class="form-check-label text-warning font-weight-bold" for="radio3">Adres zamieszkania</label>
                </div>            

                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="radiobtn" id="radio4" value=4>
                    <label class="form-check-label text-warning font-weight-bold" for="radio4">Nr telefonu</label>
                </div>

                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="radiobtn" id="radio5" value=5>
                    <label class="form-check-label text-warning font-weight-bold" for="radio5">Adres e-mail</label>
                </div>

                <div class="form-check form-check-inline">
                    <input class="form-check-input" type="radio" name="radiobtn" id="radio6" value=6>
                    <label class="form-check-label text-warning font-weight-bold" for="radio6">Nazwa użytkownika</label>
                </div>              
            </div>
                                    ...
                                    else
                                    {
                                        ...
                                        else
                                        {
                                            while ($row = $result->fetch_assoc())
                                            {
                                                ...
                                                echo "<tr id='row$id'><td><b>".$row['ID_klienta']."</b></td><td>".$row['Imię']."</td><td>".$row['Nazwisko']."</td><td>".$row['Adres_zamieszkania']."</td><td>".
                                                $row['Nr_telefonu']."</td><td>".$row['Adres_email']."</td><td>".$row['Nazwa_użytkownika']."</td>";

                                                echo "<td><a href='edycja/klienci_edycja.php?id=$id' class='btn btn-primary' title='Edytuj'><i class='fas fa-edit'></i></a></td>";
        ...
        <script>
            ...
            {
                $.ajax({
                    url: "usuwanie/klienci_usuwanie.php",
                    type: "get",
                    data: "id="+id,
                    success: function(data)
                    {
                        if(data==1)
                       {
                        ...
                        {
                            alert("Nie można usunąć klient, ponieważ istnieje w bazie zamówienie dla tego klienta");
                        }
