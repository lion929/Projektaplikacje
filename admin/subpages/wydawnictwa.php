...
<html>
    ...
    <body>
            ...
            <nav class="navbar navbar-light navbar-expand-lg">
				...
				<div class="collapse navbar-collapse" id="nav">
					...
					<form class="form-inline ml-auto mr-auto">
                        ...
                        <a href="dodawanie/wydawnictwa_dodawanie.php" class="btn text-light bg-success mr-5" type="button"><i class="fas fa-plus"></i> Dodaj rekord</a>
                          ...
                          <tbody>
                            <?php
                                ...
                                try {
                                    ...
                                    {
                                        $query = "SELECT * FROM wydawnictwa ORDER BY ID_wydawnictwa DESC";
                                        ...
                                        else
                                        {
                                            ...
                                            {
                                                $id = $row['ID_wydawnictwa'];

                                                echo "<tr id='row$id'><td>".$row['Nazwa'];

                                                echo "<td><a href='edycja/wydawnictwa_edycja.php?id=$id' class='btn btn-primary' title='Edytuj'><i class='fas fa-edit'></i></a></td>";
        ...
        <script>
            ...
            {
                $.ajax({
                    url: "usuwanie/wydawnictwa_usuwanie.php",
                    type: "get",
                    data: "id="+id,
                    ...
                    { 
                       ...
                       {
                           alert("Nie można usunąć tego wydawnictwa, ponieważ istnieją książki z tego wydawnictwa");
                       }
