    ...
    if(isset($_POST['imie'])){
		...
		try {
			...
			if($conn->connect_errno != 0){
				...
				$check = $conn->query("SELECT * FROM autorzy WHERE Imie='$imie' AND Nazwisko='$nazwisko'");
				if(!$check) 
				...
				if($ok == true)
				{
					if($conn->query("INSERT INTO autorzy VALUES (NULL, '$imie', '$nazwisko')")){
                ...
                <form action="" method="post" autocomplete="off">
					...
					<div class="form-row">
						<div class="col-md-6 mb-3">
							...
							<input type="text" class="form-control bg-dark text-light d-block" name="imie" id="imie1" placeholder="Imię" required>
						...
						<div class="col-md-6 mb-3">
							...
							<input type="text" class="form-control bg-dark text-light d-block" name="nazwisko" id="nazwisko1" placeholder="Nazwisko" required>
						</div>
					</div>
					<span style="font-weight: bold; text-shadow: 0 0 15px white;" class="text-danger form-group" id="name"></span>
