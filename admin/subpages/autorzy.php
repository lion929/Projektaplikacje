    ...
    <body>
        ...
        <main>
            ...
            <div class="container text-center mb-3">
                ...
                <span class="text-warning font-weight-bold">Nazwisko</span>         
            </div>
            ...
            <nav class="navbar navbar-light navbar-expand-lg">
				...
				<div class="collapse navbar-collapse" id="nav">
					...
					<form class="form-inline ml-auto mr-auto">
                        ...
                        <a href="dodawanie/autorzy_dodawanie.php" class="btn text-light bg-success mr-5" type="button"><i class="fas fa-plus"></i> Dodaj rekord</a>
                ...
                <div class="table-responsive">
                        ...
                        <thead>
                          ...
                          <?php
                                ...
                                try {
                                    ...
                                    {
                                        $query = "SELECT * FROM autorzy ORDER BY ID_autora DESC";
                                        ...
                                        else
                                        {
                                            while ($row = $result->fetch_assoc())
                                            {
                                                ...
                                                echo "<tr id='row$id'><td>".$row['Imie']."</td><td>".$row['Nazwisko'];

                                                echo "<td><a href='edycja/autorzy_edycja.php?id=$id' class='btn btn-primary' title='Edytuj'><i class='fas fa-edit'></i></a></td>";
                    ...
                    <script>
                        function searchFunction() 
                        {
                            ...
                            {
                                td = rows[j].getElementsByTagName("td")[1];
        ...
        <script>
            ...
            {
                $.ajax({
                    url: "usuwanie/autorzy_usuwanie.php",
                    type: "get",
                    data: "id="+id,
                    ...
                    { 
                       ...
                       {
                            alert("Nie można usunąć tego autora, ponieważ istnieje książka tego autora");
                       }
