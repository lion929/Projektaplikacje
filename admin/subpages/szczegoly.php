    ...
    <body>
        ...
        <main>
            ...
            <div class="container text-center mb-3">
                ...
                <span class="text-warning font-weight-bold">Nazwa produktu</span>   
            </div>
            ...
            <nav class="navbar navbar-light navbar-expand-lg">
				...
				<div class="collapse navbar-collapse" id="nav">
					...
					<form class="form-inline ml-auto mr-auto">
                        ...
                        <a href="dodawanie/szczegoly_dodawanie.php?id=<?php echo $idz; ?>" class="btn text-light bg-success mr-5" role="button"><i class="fas fa-plus"></i> Dodaj rekord</a>
                        ...
                        <button class="btn btn-info ml-5" type="button" onclick="count()"><i class="fas fa-dollar-sign mr-2"></i>Policz cenę</button>
					</form>
            ...
            <div class="container col-sm-8">
                ...
                <div class="table-responsive">
                          ...
                          <tbody>
                            <?php
                                ...
                                try {
                                    ...
                                    {
                                        $query = "SELECT książki.ID_ksiązki, szczegóły_zamowienia.ID, książki.Tytuł, szczegóły_zamowienia.Ilość, (szczegóły_zamowienia.Ilość*książki.Cena) as Koszt  
                                        FROM szczegóły_zamowienia INNER JOIN książki ON książki.ID_ksiązki = szczegóły_zamowienia.ID_książki WHERE szczegóły_zamowienia.ID_zamówienia=$idz"; 
                                        ...
                                        else
                                        {
                                            while ($row = $result->fetch_assoc())
                                            {
                                                ...
                                                $id = $row['ID'];
                                                echo "<tr id='row$id'><td>".$row['Tytuł'].$autorzy.$wydawnictwo."</td><td>".$row['Ilość']."</td><td>".$row['Koszt']."</td>";

                                                echo "<td><a href='edycja/szczegoly_edycja.php?id=$id' class='btn btn-primary' title='Edytuj'><i class='fas fa-edit'></i></a></td>";
                                                echo "<td><button class='btn btn-danger' type='button' title='Usuń' onclick='delete_row($id)'><i class='fas fa-trash-alt'></i></a></td></tr>";
                    ...
                    <?php
                        $query = $conn->query("SELECT Rabat FROM zamówienia WHERE ID_zamowienia = $idz");
                        $row1 = mysqli_fetch_assoc($query);

                        $suma = $suma - ($suma * ($row1['Rabat'] * 0.01));
                        echo '<span class="float-right" style="font-size: 18px; color: yellow;"><strong>Suma z rabatem: </strong>'.$suma.' zł</span>';
        ...
        <script>
            ...
            {
                $.ajax({
                    url: "usuwanie/szczegoly_usuwanie.php",
                    type: "get",
                    data: "id="+id,
